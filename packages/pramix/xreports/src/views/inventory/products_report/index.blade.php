                ...
                <div class="card-body">
                    <form class="" action="#" id="report-filter">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    {{ Form::select('product_type', Config::get('system.product_types') , ''  , array('class' => 'form-control select2' , 'id' => 'product_type','title' => '')) }}
                                </div>
                            </div>
                            <div class="col-sm-2">
...
<script>
    $(document).ready(function () {
        ...
        $("#generate_report_btn").click(function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: BASE + 'reports/generate_products_report',
                type: 'POST',
                dataType: 'JSON',
                data: $.param(params),
