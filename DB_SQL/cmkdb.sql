...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 08, 2021 at 09:18 AM
...
--
-- Table structure for table `pramix_address`
--

CREATE TABLE `pramix_address` (
  `id` int(10) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `user_type` char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'P = Prasanal , S = Supllier',
  `address_type` char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'S = Shipping , B = Billing',
  ...
  `other_city_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `district_id` int(11) DEFAULT NULL,
  `postal_code` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country` char(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `pramix_areas`
--

CREATE TABLE `pramix_areas` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `code` char(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rep_id` int(11) NOT NULL COMMENT 'user_id',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `pramix_average_cost_table`
--

CREATE TABLE `pramix_average_cost_table` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `product_id` int(11) NOT NULL,
  `ending_units` int(11) NOT NULL,
  `average_cost_per_unit` double NOT NULL,
...
--
-- Table structure for table `pramix_branches`
--

CREATE TABLE `pramix_branches` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `pramix_branches`
--

INSERT INTO `pramix_branches` (`id`, `name`, `url`, `location`, `telephone`, `created_at`, `updated_at`) VALUES
(1, 'Main', 'https://cmk.clickydms.us', 'main', NULL, '2020-04-29 18:30:00', '2020-04-29 18:30:00');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_cheque`
--

CREATE TABLE `pramix_cheque` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `pramix_cities`
--

CREATE TABLE `pramix_cities` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `district_id` int(11) NOT NULL,
  `name_en` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_si` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_ta` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sub_name_en` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sub_name_si` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sub_name_ta` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `pramix_cities`
--

INSERT INTO `pramix_cities` (`id`, `district_id`, `name_en`, `name_si`, `name_ta`, `sub_name_en`, `sub_name_si`, `sub_name_ta`, `postcode`, `latitude`, `longitude`) VALUES
...
--
-- Table structure for table `pramix_comments`
--

CREATE TABLE `pramix_comments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ref_id` int(11) NOT NULL,
  `comments` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `comment_type` char(5) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `pramix_configurations`
--

CREATE TABLE `pramix_configurations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `config_type` char(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  `options` text COLLATE utf8mb4_unicode_ci,
  `default_value` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `value` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `options_array` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `category_id` int(11) NOT NULL,
  `status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hidden` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `pramix_configurations`
--

INSERT INTO `pramix_configurations` (`id`, `name`, `display_name`, `config_type`, `options`, `default_value`, `value`, `options_array`, `category_id`, `status`, `hidden`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'TITLE', 'Title', 'DD', NULL, NULL, 'Mr', '\"{\\\"Mr\\\":\\\"Mr\\\",\\\"Mrs\\\":\\\"Mrs\\\",\\\"Ms\\\":\\\"Ms\\\",\\\"Dr\\\":\\\"Dr\\\",\\\"Prof\\\":\\\"Prof\\\",\\\"Master\\\":\\\"Master\\\",\\\"Reverent\\\":\\\"Reverent\\\"}\"', 1, '1', '0', 1, 1, NULL, '2019-09-27 01:30:11', '2019-11-08 02:37:34'),
(2, 'DISCOUNT_TYPE', 'Discount Type', 'DD', NULL, NULL, 'P', '\"{\\\"A\\\":\\\"Amount\\\",\\\"P\\\":\\\"Percentage (%)\\\"}\"', 1, '1', '0', 1, 1, NULL, '2019-09-27 01:41:09', '2019-10-09 22:41:35'),
(3, 'INQUIRY_STATUS', 'Inquiry status', 'DD', NULL, NULL, 'P', '\"{\\\"P\\\":\\\"Pending\\\",\\\"O\\\":\\\"Processing\\\",\\\"C\\\":\\\"Completed\\\",\\\"R\\\":\\\"Rejected\\\"}\"', 1, '1', '0', 1, 1, NULL, '2019-10-01 01:40:14', '2019-10-30 04:36:51'),
(4, 'INQUIRY_PRIORITY', 'Inquiry Priority', 'DD', NULL, NULL, 'N', '\"{\\\"L\\\":\\\"Low\\\",\\\"N\\\":\\\"Normal\\\",\\\"H\\\":\\\"High\\\",\\\"U\\\":\\\"Urgent\\\"}\"', 2, '1', '0', 1, 1, NULL, '2019-10-01 01:48:17', '2019-10-30 04:34:28'),
(5, 'DEFAULT_CURRENCY', 'Default Currency', 'TX', NULL, NULL, 'Rs.', NULL, 1, '1', '0', 1, 1, NULL, '2019-10-11 04:12:16', '2019-10-11 04:12:16'),
(6, 'ADDRESS_USER_TYPE', 'Address user type', 'DD', NULL, NULL, '', '\"{\\\"supplier\\\":\\\"S\\\",\\\"customer\\\":\\\"C\\\"}\"', 2, '1', '0', 1, 1, NULL, '2019-10-16 22:33:46', '2019-10-16 22:33:46'),
(7, 'VAT_PERCENTAGE', 'VAT_PERCENTAGE', 'TX', NULL, NULL, '15', NULL, 1, '1', '0', 1, 1, NULL, '2019-10-21 05:24:59', '2019-10-21 05:24:59'),
(8, 'NBT_PERCENTAGE', 'NBT_PERCENTAGE', 'TX', NULL, NULL, '2', NULL, 1, '1', '0', 1, 1, NULL, '2019-10-21 05:25:13', '2019-10-21 05:25:13'),
(9, 'MEDIA_TYPES', 'Media Types', 'DD', NULL, NULL, '', '\"{\\\"products_media\\\":\\\"products_media\\\",\\\"project_attachments\\\":\\\"project_attachments\\\",\\\"finance_attachments\\\":\\\"finance_attachments\\\",\\\"company_logo\\\":\\\"company_logo\\\"}\"', 2, '1', '0', 1, 1, NULL, '2019-10-26 21:26:52', '2019-11-06 03:18:01'),
(10, 'TRANSACTION_TYPES', 'Transaction Types', 'DD', NULL, NULL, '', '\"{\\\"stock_adjustment\\\":\\\"1\\\",\\\"sales_order\\\":\\\"2\\\",\\\"grn\\\":\\\"3\\\",\\\"purchase_returns\\\":\\\"4\\\",\\\"invoice_return\\\":\\\"5\\\"}\"', 2, '1', '0', 1, 1, NULL, '2019-10-30 12:19:32', '2019-10-30 12:19:32'),
(11, 'STOCK_TRANSACTION_TYPES', 'Stock Transaction Types', 'DD', NULL, NULL, '', '\"{\\\"stock_adjustment\\\":\\\"1\\\",\\\"sales_order\\\":\\\"2\\\",\\\"grn\\\":\\\"3\\\",\\\"purchase_returns\\\":\\\"4\\\",\\\"invoice_return\\\":\\\"5\\\",\\\"manual_update\\\":\\\"6\\\",\\\"production_consumed_product\\\":\\\"7\\\",\\\"production\\\":\\\"8\\\"}\"', 2, '1', '0', 1, 1, NULL, '2019-10-30 13:30:18', '2020-05-06 18:34:06'),
(12, 'TRANSMISSION_TYPES', 'Transmission Types', 'DD', NULL, NULL, '', '\"{\\\"M\\\":\\\"Manual\\\",\\\"A\\\":\\\"Automatic\\\",\\\"T\\\":\\\"Tiptronic\\\",\\\"O\\\":\\\"Other Transmission\\\"}\"', 4, '1', '0', 1, 1, NULL, '2019-11-05 17:26:52', '2019-11-05 17:26:52'),
(13, 'COMPANY_DETAILS', 'Company Details', 'DD', NULL, NULL, '', '\"{\\\"_token\\\":\\\"KIQmAvpP1uohgNcEozubP7uPsS0GidrBLmfsnQuH\\\",\\\"ref_id\\\":\\\"\\\",\\\"media_type\\\":\\\"company_logo\\\",\\\"media_ids\\\":\\\"\\\",\\\"company_name\\\":\\\"CMK Enterprises\\\",\\\"mobile\\\":\\\"0472237130\\\",\\\"telephone\\\":\\\"0472238130\\\",\\\"email\\\":\\\"sbscom@sltnet.lk\\\",\\\"website\\\":\\\"www.sbssrilanka.com\\\",\\\"street1\\\":\\\"No.479\\\",\\\"street2\\\":\\\"Debarawewa\\\",\\\"city\\\":\\\"Thissamaharama\\\",\\\"country\\\":\\\"LK\\\"}\"', 1, '1', '0', 1, 5, NULL, '2019-11-06 18:14:37', '2020-06-01 08:36:18'),
(14, 'CUSTOMER_TYPE', 'Customer Type', 'DD', NULL, NULL, 'C', '\"{\\\"C\\\":\\\"Customer\\\",\\\"B\\\":\\\"Company\\\"}\"', 1, '1', '0', 1, 1, NULL, '2019-11-28 07:28:12', '2019-11-28 07:28:12'),
(15, 'AOD_REASON', 'AOD Reason', 'DD', NULL, NULL, '', '\"{\\\"\\\":\\\"Select Reason\\\",\\\"st\\\":\\\"Stand by\\\",\\\"de\\\":\\\"Demonstration\\\",\\\"wc\\\":\\\"Warranty Claim\\\",\\\"do\\\":\\\"Donation\\\"}\"', 1, '1', '0', 1, 1, NULL, '2019-12-05 11:05:52', '2019-12-05 11:05:52'),
(16, 'RECURRING_TYPE', 'Recurring Type', 'DD', NULL, NULL, '', '\"{\\\"M\\\":\\\"Monthly\\\",\\\"Y\\\":\\\"Yearly\\\",\\\"\\\":\\\"Select Recurring Type\\\"}\"', 1, '1', '0', 1, 1, NULL, '2019-12-23 10:16:00', '2019-12-24 04:58:55'),
(17, 'SMS_CONFIG', 'Sms Config', 'DD', NULL, NULL, '', '\"{\\\"sms_api_key\\\":\\\"J7ZR-O1QW-N9WZ-P03T-AIL4\\\",\\\"sms_api_secret\\\":\\\"56Rv5ajLd3IIccja1OCV\\\"}\"', 5, '1', '0', 1, 1, NULL, '2020-01-01 04:58:05', '2020-01-01 04:58:05'),
(18, 'GRN_TAX', 'GRN TAX', 'TX', NULL, NULL, 'FALSE', NULL, 2, '1', '0', 1, 1, NULL, '2020-04-22 16:23:23', '2020-04-22 16:23:23'),
(19, 'INVOICE_TAX', 'Invoice Tax', 'TX', NULL, NULL, 'FALSE', NULL, 2, '1', '0', 1, 1, NULL, '2020-04-22 16:24:17', '2020-04-22 16:24:17'),
(20, 'ENABLE_INVOICE_RECURRING', 'Enable Invoice Recurring', 'TX', NULL, NULL, 'FALSE', NULL, 2, '1', '0', 1, 1, NULL, '2020-04-22 16:37:46', '2020-04-22 16:37:46'),
(21, 'INVOICE_COMPANY', 'Invoice Company', 'DD', NULL, NULL, '1', '\"{\\\"1\\\":\\\"Hasinidu Rice Mill\\\",\\\"2\\\":\\\"Hasinidu Steam Rice Mill\\\"}\"', 2, '1', '0', 1, 5, NULL, '2020-04-29 23:56:18', '2020-06-01 08:25:29'),
(22, 'PRODUCTION_COST_TYPE', 'Production Cost Type', 'DD', NULL, NULL, '', '\"{\\\"1\\\":\\\"Labor Cost\\\",\\\"2\\\":\\\"Machine Cost\\\",\\\"3\\\":\\\"Overhead Cost\\\"}\"', 1, '1', '0', 1, 1, NULL, '2020-04-30 13:54:12', '2020-04-30 13:54:12'),
(23, 'CUSTOMER_INVOICE_TYPES', 'Customer Invoice Types', 'DD', NULL, NULL, '10', '\"{\\\"10\\\":\\\"10\\\",\\\"35\\\":\\\"35\\\"}\"', 1, '1', '0', 5, 5, NULL, '2020-08-07 04:47:48', '2020-08-07 04:48:55'),
(24, 'BANKS_LIST', 'Banks List', 'DD', NULL, NULL, '', '\"[\\\"Amana Bank\\\",\\\"Bank of Ceylon\\\",\\\"Cargills Bank Ltd\\\",\\\"Commercial Bank of Ceylon PLC\\\",\\\"DFCC Bank PLC\\\",\\\"Hatton National Bank PLC\\\",\\\"National Development Bank PLC\\\",\\\"Nations Trust Bank PLC\\\",\\\"Pan Asia Banking Corporation PLC\\\",\\\"People\'s Bank\\\",\\\"Sampath Bank PLC\\\",\\\"Seylan Bank PLC\\\",\\\"Other Bank\\\"]\"', 1, '1', '0', 5, 5, NULL, '2020-08-18 00:15:37', '2020-08-18 00:19:48'),
(25, 'INVOICE_STATUS', 'Invoice Status', 'DD', NULL, NULL, '', '\"{\\\"O\\\":\\\"Order\\\",\\\"D\\\":\\\"Ready to Dispatch\\\",\\\"I\\\":\\\"Invoice\\\",\\\"Q\\\":\\\"Quick Sell\\\"}\"', 1, '1', '0', 5, 5, NULL, '2020-08-29 12:58:13', '2020-08-29 18:14:30'),
(26, 'outstanding_max_days', 'outstanding max days', 'TX', NULL, NULL, '150', NULL, 1, '1', '0', 5, 5, NULL, '2021-01-23 04:31:39', '2021-01-23 04:31:39');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_configuration_category`
--

CREATE TABLE `pramix_configuration_category` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `pramix_configuration_category`
--

INSERT INTO `pramix_configuration_category` (`id`, `name`, `description`, `status`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 'General', 'General', '1', 1, 1, NULL, '2019-09-27 01:27:55', '2019-09-27 01:27:55'),
(2, 'System Configuration', '', '1', 1, 1, NULL, '2019-10-16 22:31:33', '2019-10-16 22:31:33'),
(3, 'Media Types', '', '1', 1, 1, NULL, '2019-10-26 21:25:17', '2019-10-26 21:25:17'),
(4, 'Vehicles', '', '1', 1, 1, NULL, '2019-11-05 17:24:21', '2019-11-05 17:24:21'),
(5, 'Communication', '', '1', 1, 1, NULL, '2020-01-01 04:55:14', '2020-01-01 04:55:14');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_customer`
--

CREATE TABLE `pramix_customer` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `title` char(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `business_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_type` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_branch` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `passport_expire_date` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `outstanding_max_days` double DEFAULT NULL,
  ...
  `status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `invoice_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '10 or 35',
...
--
-- Dumping data for table `pramix_customer`
--

INSERT INTO `pramix_customer` (`id`, `branch_id`, `title`, `business_name`, `customer_type`, `company_name`, `company_branch`, `fname`, `lname`, `nic`, `tax_no`, `passport_no`, `passport_expire_date`, `telephone`, `mobile`, `fax`, `email`, `dob`, `gender`, `website`, `remarks`, `outstanding_amount`, `outstanding_max_days`, `outstanding_limit`, `credit_balance`, `discount`, `discount_type`, `status`, `invoice_type`, `area_id`, `rep_id`, `user_account_id`, `user_id`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 1, 'Mr', 'AA', '', 'Clicky Solutions', '', 'Oditha', 'Wanasinghe', '', '', NULL, NULL, '', '+94771981680', '', 'oditha@clicky.lk', NULL, '', '', '', NULL, 150, 600000, NULL, 0, 'P', 'A', '10', NULL, 23, NULL, NULL, 1, 1, NULL, '2021-09-01 15:25:12', '2021-09-01 15:25:12'),
(2, 1, 'Mr', 'AAD', '', 'Clicky Solutions', '', 'Oditha', 'Wanasinghe', '', '', NULL, NULL, '', '+94771981681', '', 'oditha2@clicky.lk', NULL, '', '', '', NULL, 150, 600000, NULL, 0, 'P', 'A', '10', NULL, 23, NULL, NULL, 1, 1, NULL, '2021-09-01 15:30:55', '2021-09-01 15:30:55'),
(3, 1, 'Mr', 'XX', '', 'Clicky I T Solutions (Private) Limited', '', 'Oditha', 'Wanasinghe', '', '', NULL, NULL, '', '+94777311381', '', 'clickylk@gmail.com', NULL, '', '', '', NULL, 150, 600000, NULL, 0, 'P', 'A', '10', NULL, 23, NULL, NULL, 1, 1, NULL, '2021-09-01 15:32:07', '2021-09-01 15:32:07');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_customer_account_activities`
--

CREATE TABLE `pramix_customer_account_activities` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Table structure for table `pramix_districts`
--

CREATE TABLE `pramix_districts` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `pramix_districts`
--

INSERT INTO `pramix_districts` (`id`, `province_id`, `name_en`, `name_si`, `name_ta`) VALUES
...
--
-- Table structure for table `pramix_emails`
--

CREATE TABLE `pramix_emails` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `email_type` char(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `pramix_email_templates`
--

CREATE TABLE `pramix_email_templates` (
  `id` int(10) UNSIGNED NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `editor_content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Table structure for table `pramix_error_log_details`
--

CREATE TABLE `pramix_error_log_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `pramix_etemplates`
--

CREATE TABLE `pramix_etemplates` (
  `id` int(10) UNSIGNED NOT NULL,
  `template_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'E = Email , S = SMS',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `pramix_failed_jobs`
--

CREATE TABLE `pramix_failed_jobs` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `pramix_file_uploaded_details`
--

CREATE TABLE `pramix_file_uploaded_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `upload_type` char(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'P = Product / PC = Product Category / C = Customer',
  `lines_total` int(11) DEFAULT NULL,
  `lines_succeeded` int(11) DEFAULT NULL,
...
--
-- Table structure for table `pramix_grn`
--

CREATE TABLE `pramix_grn` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `pramix_grn_product`
--

CREATE TABLE `pramix_grn_product` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `pramix_grn_return`
--

CREATE TABLE `pramix_grn_return` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `grn_return_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `supplier_id` int(11) DEFAULT NULL,
  `grn_id` int(11) DEFAULT NULL,
  `grn_return_date` date NOT NULL,
  ...
  `discount_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'P',
...
--
-- Table structure for table `pramix_grn_return_products`
--

CREATE TABLE `pramix_grn_return_products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `grn_return_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
...
--
-- Table structure for table `pramix_inventory`
--

CREATE TABLE `pramix_inventory` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `pramix_invoice`
--

CREATE TABLE `pramix_invoice` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  ...
  `status` char(4) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sub_total` double NOT NULL DEFAULT '0',
  `extra_charge_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `extra_charge` double DEFAULT NULL,
  `remarks` text COLLATE utf8mb4_unicode_ci,
  `discount` int(11) NOT NULL DEFAULT '0',
  `vat_amount` double NOT NULL,
  `nbt_amount` double NOT NULL,
  `discount_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'P',
  `total` double NOT NULL DEFAULT '0',
  `returned_amount` double DEFAULT '0',
  `paid_amount` double DEFAULT NULL,
  `balance` double DEFAULT NULL,
  `ref_id` int(11) DEFAULT NULL,
  `type` char(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_company` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `assigned_user` int(11) DEFAULT NULL,
  `cash_sell` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0' COMMENT '1/0',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `pramix_invoice_payments`
--

CREATE TABLE `pramix_invoice_payments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `payment_code` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoice_id` int(11) NOT NULL,
  `payment_date` date NOT NULL,
  `payment_method` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `pramix_invoice_products`
--

CREATE TABLE `pramix_invoice_products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `invoice_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `pramix_invoice_recurring`
--

CREATE TABLE `pramix_invoice_recurring` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `invoice_id` int(11) NOT NULL,
  `billing_cycle` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `monthly_generated_date` int(11) DEFAULT NULL,
  `yearly_generated_month` int(11) DEFAULT NULL,
  `status` char(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `pramix_invoice_return`
--

CREATE TABLE `pramix_invoice_return` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `invoice_return_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` int(11) DEFAULT NULL,
  ...
  `customer_credit` double NOT NULL DEFAULT '0',
  `remarks` text COLLATE utf8mb4_unicode_ci,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `pramix_invoice_return_product`
--

CREATE TABLE `pramix_invoice_return_product` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `pramix_manufacture`
--

CREATE TABLE `pramix_manufacture` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `pramix_media`
--

CREATE TABLE `pramix_media` (
  `id` int(10) UNSIGNED NOT NULL,
  `ref_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `pramix_media`
--

INSERT INTO `pramix_media` (`id`, `ref_id`, `media_type`, `folder_name`, `file_name`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(1, 70, 'products_media', 'products_media/2020_08', 'fruit.jpg', 5, 5, NULL, '2020-08-18 00:09:32', '2020-08-18 00:09:32'),
(2, 70, 'products_media', 'products_media/2020_08', 'papaya-tree-2918226_640.jpg', 5, 5, '2020-08-25 04:31:56', '2020-08-18 00:09:40', '2020-08-25 04:31:56'),
(3, 71, 'products_media', 'products_media/2020_08', 'binding_large.jpeg', 5, 5, NULL, '2020-08-30 05:49:42', '2020-08-30 05:50:08'),
(4, NULL, 'products_media', 'products_media/2020_12', '4RJ56PA-2_T1539235805.png', 5, 5, NULL, '2020-12-20 14:39:55', '2020-12-20 14:39:55'),
(5, NULL, 'products_media', 'products_media/2020_12', '4RJ56PA-2_T1539235805.png', 5, 5, NULL, '2020-12-20 14:40:27', '2020-12-20 14:40:27'),
(6, NULL, 'products_media', 'products_media/2020_12', 'man-car-trip.jpg', 5, 5, NULL, '2020-12-20 14:42:15', '2020-12-20 14:42:15'),
(7, 99, 'products_media', 'products_media/2020_12', '0d6a829f7e08fa324effc8fa72a6bf01.jpg', 5, 5, '2020-12-20 15:54:27', '2020-12-20 14:49:25', '2020-12-20 15:54:27'),
(8, 99, 'products_media', 'products_media/2020_12', '1_(4).jpg', 5, 5, '2020-12-20 15:54:24', '2020-12-20 15:54:17', '2020-12-20 15:54:24'),
(9, 92, 'products_media', 'products_media/2020_12', 'PS-334.jpg', 9, 9, NULL, '2020-12-21 08:16:35', '2020-12-21 08:16:35'),
(10, 92, 'products_media', 'products_media/2020_12', 'PS-334-2.jpg', 9, 9, NULL, '2020-12-21 08:16:43', '2020-12-21 08:16:43'),
(11, 91, 'products_media', 'products_media/2020_12', 'RL-211A.jpg', 9, 9, NULL, '2020-12-21 08:18:31', '2020-12-21 08:18:31'),
(12, 96, 'products_media', 'products_media/2020_12', 'HD-2P.jpg', 9, 9, '2020-12-21 08:20:58', '2020-12-21 08:20:40', '2020-12-21 08:20:58'),
(13, 96, 'products_media', 'products_media/2020_12', 'HD-2P-2.jpg', 9, 9, NULL, '2020-12-21 08:20:49', '2020-12-21 08:20:49'),
(14, 96, 'products_media', 'products_media/2020_12', 'HD-2P-3.jpg', 9, 9, NULL, '2020-12-21 08:21:11', '2020-12-21 08:21:11'),
(15, NULL, 'company_logo', 'company_logo/2021_01', 'Logo.jpg', 9, 9, NULL, '2021-01-05 03:25:17', '2021-01-05 03:25:17'),
(16, NULL, 'company_logo', 'company_logo/2021_01', 'Logo_-_Copy_(2).jpg', 9, 9, NULL, '2021-01-05 03:42:24', '2021-01-05 03:42:24'),
(17, NULL, 'company_logo', 'company_logo/2021_01', 'Logo_-_Copy_(3).jpg', 9, 9, NULL, '2021-01-05 03:44:40', '2021-01-05 03:44:40'),
(18, NULL, 'company_logo', 'company_logo/2021_01', '1609827319-Logo_-_Copy_(3).jpg', 9, 9, NULL, '2021-01-05 03:45:19', '2021-01-05 03:45:19'),
(19, NULL, 'company_logo', 'company_logo/2021_01', 'Letter_Head_.jpg', 9, 9, NULL, '2021-01-05 03:46:51', '2021-01-05 03:46:51'),
(20, NULL, 'company_logo', 'company_logo/2021_01', '1609827475-Logo_-_Copy_(3).jpg', 9, 9, NULL, '2021-01-05 03:47:55', '2021-01-05 03:47:55');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_media_sort`
--

CREATE TABLE `pramix_media_sort` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `ref_id` int(11) DEFAULT NULL,
  `media_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image_order` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `pramix_media_sort`
--

INSERT INTO `pramix_media_sort` (`id`, `ref_id`, `media_type`, `image_order`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 70, 'products_media', '1', 5, 5, '2020-08-18 00:09:33', '2020-08-25 04:31:56'),
(2, 71, 'products_media', '3', 5, 5, '2020-08-30 05:50:08', '2020-08-30 05:50:08'),
(3, 99, 'products_media', '7', 5, 5, '2020-12-20 14:49:26', '2020-12-20 15:54:24'),
(4, 92, 'products_media', '9,10', 9, 9, '2020-12-21 08:16:35', '2020-12-21 08:16:43'),
(5, 91, 'products_media', '11', 9, 9, '2020-12-21 08:18:31', '2020-12-21 08:18:31'),
(6, 96, 'products_media', '13,14', 9, 9, '2020-12-21 08:20:40', '2020-12-21 08:21:11');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_migrations`
--

CREATE TABLE `pramix_migrations` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `pramix_migrations`
--

INSERT INTO `pramix_migrations` (`id`, `migration`, `batch`) VALUES
(1, '2014_10_12_000000_create_users_table', 1),
(2, '2014_10_12_100000_create_password_resets_table', 1),
(3, '2017_10_17_185030_create_templates_table', 1),
(4, '2018_01_29_174402_create_media_table', 1),
(5, '2018_02_02_035125_entrust_setup_tables', 1),
(6, '2018_06_11_161846_create_sendsms_table', 1),
(7, '2018_06_11_162451_create_sms_types_table', 1),
(8, '2018_06_14_054259_create_address_table', 1),
(9, '2018_06_26_062923_create_emails_templates_table', 1),
(10, '2019_02_26_125126_create_file_uploaded_detail_table', 1),
(11, '2019_02_26_125150_create_error_log_details_table', 1),
(12, '2019_08_19_000000_create_failed_jobs_table', 1),
(13, '2019_09_18_113319_create_customer_table', 1),
(14, '2019_09_21_053316_create_comments_table', 1),
(15, '2019_09_23_034921_add_comment_type_to_comments_table', 1),
(16, '2019_09_24_190917_create_configurations_table', 1),
(17, '2019_09_25_034228_create_product_table', 1),
(18, '2019_09_25_035554_create_configurations_category_table', 1),
(19, '2019_09_25_042245_create_product_categories_table', 1),
(20, '2019_09_25_045653_create_product_discount_table', 1),
(21, '2019_10_10_021040_add_hidden_column_to_configurations', 1),
(22, '2019_10_14_055458_remove_comment_type_and_add_comment_table', 1),
(23, '2019_10_14_060022_add_comment_type_to_comment_table', 1),
(24, '2019_10_14_084433_create_invoice_table', 1),
(25, '2019_10_14_112152_create_invoice_products_table', 1),
(26, '2019_10_15_054318_create_invoice_payments_table', 1),
(27, '2019_10_18_165949_create_media_sort_table', 1),
(28, '2019_10_20_162626_add_user_theme_to_users_table', 1),
(29, '2019_10_21_104918_add_vat_nbt_to_invoice_table', 1),
(30, '2019_10_22_050113_add_quotation_id_to_invoice_table', 1),
(31, '2019_10_25_095557_add_project_id_to_invoice_table', 1),
(32, '2019_10_26_045325_create_permission_tables', 1),
(33, '2019_10_26_134824_add_permission_type_to_users_table', 1),
(34, '2019_10_26_173753_add_user_id_to_customer_table', 1),
(35, '2019_10_29_072107_create_grn_table', 1),
(36, '2019_10_29_072137_create_grn_product_table', 1),
(37, '2019_10_29_074332_create_inventory_table', 1),
(38, '2019_10_29_100820_create_average_cost_table', 1),
(39, '2019_10_30_082112_create_invoice_return_table', 1),
(40, '2019_10_30_082349_create_invoice_return_product_table', 1),
(41, '2019_10_31_042452_drop_type_from_invoice_products_table', 1),
(42, '2019_10_31_092031_add_status_to_invoice_return_product_table', 1),
(43, '2019_10_31_101101_add_cost_to_invoice_products_table', 1),
(44, '2019_11_03_022933_add_user_account_id_to_customer_table', 1),
(45, '2019_11_04_181243_add_outstanding_amount_to_customer_table', 1),
(46, '2019_11_07_161518_add_tax_no_to_customer_table', 1),
(47, '2019_11_07_161920_add_due_date_to_invoice_table', 1),
(48, '2019_11_09_012011_create_product_store_locations_table', 1),
(49, '2019_11_09_012302_add_store_location_to_product_table', 1),
(50, '2019_11_10_122836_create_grn_return_table', 1),
(51, '2019_11_10_122910_create_grn_return_products_table', 1),
(52, '2019_11_11_154048_add_refund_to_invoice_return_table', 1),
(53, '2019_11_15_115508_add_code_and_status_to_invoice_payments_table', 1),
(54, '2019_11_23_061936_add_other_city_to_address_table', 1),
(55, '2019_11_28_124324_add_company_name_and_location_to_customer_table', 1),
(56, '2019_11_29_144632_add_rent_fee_to_product_table', 1),
(57, '2019_12_02_113859_add_other_city_name_null_to_address_table', 1),
(58, '2019_12_02_160012_add_assigned_user_to_invoice_table', 1),
(59, '2019_12_04_131012_add_job_card_id_to_invoice_table', 1),
(60, '2019_12_17_101436_create_emails_table', 1),
(61, '2019_12_23_125050_create_invoice_recurring_table', 1),
(62, '2019_12_23_125733_add_extra_charge_to_invoice_table', 1),
(63, '2020_01_03_092224_change_other_city_name_to_nullable_in_address_table', 1),
(64, '2020_01_21_170839_add_branch_id_to_all_tables', 1),
(65, '2020_01_22_141342_create_branches_table', 1),
(66, '2020_04_25_235131_create_product_raw_materials_table', 1),
(67, '2020_04_29_171522_add_store_id_to_inventory_table', 1),
(68, '2020_04_29_175938_add_active_status_to_inventory_table', 1),
(69, '2020_04_30_000323_add_invoice_company_id_to_invoice_table', 1),
(70, '2020_04_30_062421_add_store_id_to_invoice_products_table', 1),
(71, '2020_04_30_062526_add_store_id_to_grn_products_table', 1),
(72, '2020_05_01_054318_create_purchase_order_payments_table', 1),
(73, '2020_05_01_084433_create_purchase_order_table', 1),
(74, '2020_05_01_112152_create_purchase_order_products_table', 1),
(75, '2020_05_02_214808_create_customer_account_activities_table', 1),
(76, '2020_05_05_111537_add_credit_balance_to_customer_table', 1),
(77, '2020_05_11_161529_add_show_in_invoice_to_product_categories_table', 1),
(78, '2020_05_11_171544_add_kg_to_product_table', 1),
(79, '2020_05_21_084702_add_default_store_location_to_product_table', 1),
(80, '2020_06_02_103306_add_cheque_to_invoice_payments_table', 1),
(81, '2020_06_08_125503_create_cheque_table', 1),
(82, '2020_08_03_201648_create_areas_table', 1),
(83, '2020_08_04_085837_add_area_to_customer_table', 1),
(84, '2020_08_06_164439_add_parent_id_to_product_categories_table', 1),
(85, '2020_08_08_080556_add_selling_price_to_grn_product_table', 1),
(86, '2020_08_10_193306_add_stock_id_to_product_table', 1),
(87, '2020_08_10_193711_create_manufacture_table', 1),
(88, '2020_08_18_060848_add_cheque_bank_id_to_invoice_payments_table', 1),
(89, '2020_08_30_055917_add_cheque_id_to_invoice_payments_table', 1),
(90, '2020_12_21_090359_add_rep_id_to_invoice_table', 1),
(91, '2020_12_22_095129_add_outstanding_limit_to_customer_table', 1),
(92, '2021_01_23_091956_add_outstanding_day_limit_to_customer_table', 1);

-- --------------------------------------------------------

--
-- Table structure for table `pramix_model_has_permissions`
--

CREATE TABLE `pramix_model_has_permissions` (
...
--
-- Table structure for table `pramix_model_has_roles`
--

CREATE TABLE `pramix_model_has_roles` (
...
--
-- Dumping data for table `pramix_model_has_roles`
--

INSERT INTO `pramix_model_has_roles` (`role_id`, `model_type`, `model_id`) VALUES
(1, 'Pramix\\XUser\\Models\\User', 1),
(1, 'Pramix\\XUser\\Models\\User', 5),
(1, 'Pramix\\XUser\\Models\\User', 9),
(1, 'Pramix\\XUser\\Models\\User', 13),
(2, 'Pramix\\XUser\\Models\\User', 4),
(2, 'Pramix\\XUser\\Models\\User', 6),
(4, 'Pramix\\XUser\\Models\\User', 7),
(4, 'Pramix\\XUser\\Models\\User', 30),
(5, 'Pramix\\XUser\\Models\\User', 10),
(5, 'Pramix\\XUser\\Models\\User', 22),
(5, 'Pramix\\XUser\\Models\\User', 31),
(6, 'Pramix\\XUser\\Models\\User', 8),
(6, 'Pramix\\XUser\\Models\\User', 11),
(6, 'Pramix\\XUser\\Models\\User', 24),
(7, 'Pramix\\XUser\\Models\\User', 12),
(7, 'Pramix\\XUser\\Models\\User', 14),
(7, 'Pramix\\XUser\\Models\\User', 15),
(7, 'Pramix\\XUser\\Models\\User', 16),
(7, 'Pramix\\XUser\\Models\\User', 17),
(7, 'Pramix\\XUser\\Models\\User', 18),
(7, 'Pramix\\XUser\\Models\\User', 19),
(7, 'Pramix\\XUser\\Models\\User', 20),
(7, 'Pramix\\XUser\\Models\\User', 21),
(7, 'Pramix\\XUser\\Models\\User', 23),
(7, 'Pramix\\XUser\\Models\\User', 25),
(7, 'Pramix\\XUser\\Models\\User', 26),
(7, 'Pramix\\XUser\\Models\\User', 27),
(7, 'Pramix\\XUser\\Models\\User', 28),
(7, 'Pramix\\XUser\\Models\\User', 29);

-- --------------------------------------------------------

--
-- Table structure for table `pramix_password_resets`
--

CREATE TABLE `pramix_password_resets` (
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `pramix_permissions`
--

CREATE TABLE `pramix_permissions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `pramix_permissions`
--

INSERT INTO `pramix_permissions` (`id`, `name`, `description`, `display_name`, `guard_name`, `parent_id`, `created_at`, `updated_at`) VALUES
(1, 'MANAGE_CUSTOMERS', '', 'Manage Customers', 'web', 0, '2019-10-26 06:02:36', '2019-11-10 09:21:00'),
(3, 'ADD_CUSTOMER', '', 'Add Customer', 'web', 1, '2019-11-10 09:21:19', '2019-11-10 09:21:19'),
(4, 'EDIT_CUSTOMER', '', 'Edit Customer', 'web', 1, '2019-11-10 09:21:29', '2019-11-10 09:21:29'),
(7, 'MANAGE_PRODUCTS', '', 'Manage Products', 'web', 0, '2019-11-10 09:22:20', '2019-11-10 09:22:20'),
(8, 'ADD_PRODUCTS', '', 'Add Products', 'web', 7, '2019-11-10 09:22:34', '2019-11-10 09:22:34'),
(9, 'EDIT_PRODUCTS', '', 'Edit Products', 'web', 7, '2019-11-10 09:23:21', '2019-11-10 09:23:21'),
(101, 'ADD_BILL_PAYMENT', '', 'Add bill payment', 'web', 100, '2020-05-07 05:37:28', '2020-05-07 05:37:28'),
(12, 'MANAGE_PRODUCT_CATEGORIES', '', 'Manage Product Categories', 'web', 7, '2019-11-10 09:46:31', '2019-11-10 09:46:31'),
(13, 'MANAGE_SUPPLIERS', '', 'Manage Suppliers', 'web', 0, '2019-11-12 20:22:55', '2019-11-12 20:22:55'),
(14, 'ADD_SUPPLIER', '', 'Add Supplier', 'web', 13, '2019-11-12 20:23:25', '2019-11-12 20:23:25'),
(15, 'EDIT_SUPPLIER', '', 'Edit Supplier', 'web', 13, '2019-11-12 20:23:59', '2019-11-12 20:23:59'),
(100, 'MANAGE_BILL_PAYMENT', '', 'Manage bill payment', 'web', 0, '2020-05-07 05:33:12', '2020-05-07 05:33:12'),
(20, 'MANAGE_GRN', '', 'Manage GRN', 'web', 0, '2019-11-13 02:45:36', '2019-11-13 02:45:36'),
(21, 'ADD_GRN', '', 'Add GRN', 'web', 20, '2019-11-13 02:45:56', '2019-11-13 02:46:32'),
(22, 'EDIT_GRN', '', 'Edit GRN', 'web', 20, '2019-11-13 02:46:19', '2019-11-13 02:46:19'),
(23, 'APPROVE_GRN', '', 'Approve GRN', 'web', 20, '2019-11-13 02:51:50', '2019-11-13 02:51:50'),
(25, 'MANAGE_GRN_RETURN', '', 'Manage GRN Return', 'web', 0, '2019-11-13 06:20:11', '2019-11-13 06:20:11'),
(26, 'ADD_GRN_RETURN', '', 'Add GRN Return', 'web', 25, '2019-11-13 06:20:38', '2019-11-13 06:20:38'),
(27, 'EDIT_GRN_RETURN', '', 'Edit GRN Return', 'web', 25, '2019-11-13 06:21:07', '2019-11-13 06:21:57'),
(33, 'MANAGE_INVOICE', '', 'Manage invoice', 'web', 0, '2019-11-13 07:42:26', '2019-11-13 07:42:26'),
(34, 'ADD_INVOICE', '', 'Add invoice', 'web', 33, '2019-11-13 07:42:56', '2019-11-13 07:42:56'),
(35, 'EDIT_INVOICE', '', 'Edit invoice', 'web', 33, '2019-11-13 07:43:09', '2019-11-13 07:44:20'),
(37, 'MANAGE_CREDIT_NOTE', '', 'Manage credit note', 'web', 0, '2019-11-13 07:44:44', '2020-12-21 06:56:42'),
(38, 'ADD_CREDIT_NOTE', '', 'Add credit note', 'web', 37, '2019-11-13 07:45:07', '2020-12-21 06:57:10'),
(39, 'EDIT_CREDIT_NOTE', '', 'Edit credit note', 'web', 37, '2019-11-13 07:45:28', '2020-12-21 06:57:27'),
(45, 'MANAGE_CONFIGURATION', '', 'Manage configuration', 'web', 46, '2019-11-13 07:57:17', '2019-11-13 08:00:08'),
(46, 'MANAGE_SETTING', '', 'Manage setting', 'web', 0, '2019-11-13 07:57:50', '2019-11-13 07:57:50'),
(47, 'MANAGE_USERS', '', 'Manage users', 'web', 46, '2019-11-13 07:58:10', '2019-11-13 07:59:37'),
(48, 'MANAGE_ROLES', '', 'Manage roles', 'web', 46, '2019-11-13 07:58:28', '2019-11-13 07:59:51'),
(49, 'MANAGE_PERMISSIONS', '', 'Manage permissions', 'web', 46, '2019-11-13 07:59:21', '2019-11-13 07:59:21'),
(50, 'MANAGE_COMPANY_INFORMATION', '', 'Manage company information', 'web', 46, '2019-11-13 08:02:01', '2019-11-13 08:02:01'),
(51, 'MANAGE_INCOMES', '', 'Manage incomes', 'web', 0, '2019-11-13 08:02:48', '2019-11-13 08:02:48'),
(52, 'ADD_INCOMES', '', 'Add incomes', 'web', 51, '2019-11-13 08:03:10', '2019-11-13 08:03:10'),
(53, 'EDIT_INCOMES', '', 'Edit incomes', 'web', 51, '2019-11-13 08:03:23', '2019-11-13 08:03:23'),
(55, 'MANAGE_INCOME_CATEGORIES', '', 'Manage income categories', 'web', 51, '2019-11-13 08:04:35', '2019-11-13 08:04:35'),
(56, 'MANAGE_EXPENSES', '', 'Manage expenses', 'web', 0, '2019-11-13 08:04:54', '2019-11-13 08:04:54'),
(57, 'ADD_EXPENSES', '', 'Add expenses', 'web', 56, '2019-11-13 08:05:06', '2019-11-13 08:05:06'),
(58, 'EDIT_EXPENSES', '', 'Edit expenses', 'web', 56, '2019-11-13 08:05:18', '2019-11-13 08:05:18'),
(60, 'MANAGE_EXPENSE_CATEGORIES', '', 'Manage expense categories', 'web', 56, '2019-11-13 08:06:11', '2019-11-13 08:06:11'),
(61, 'ADD_PERMISSION', '', 'Add permission', 'web', 49, '2019-11-13 11:15:57', '2019-11-13 11:15:57'),
(62, 'EDIT_PERMISSION', '', 'Edit permission', 'web', 49, '2019-11-13 11:16:18', '2019-11-13 11:16:18'),
(64, 'ADD_ROLES', '', 'Add roles', 'web', 48, '2019-11-13 11:17:20', '2019-11-13 11:17:20'),
(65, 'EDIT_ROLES', '', 'Edit roles', 'web', 48, '2019-11-13 11:17:27', '2019-11-13 11:17:56'),
(67, 'ADD_USERS', '', 'Add users', 'web', 47, '2019-11-13 11:18:14', '2019-11-13 11:18:14'),
(68, 'EDIT_USERS', '', 'Edit users', 'web', 47, '2019-11-13 11:18:32', '2019-11-13 11:19:26'),
(70, 'MANAGE_REPORTS', '', 'Manage reports', 'web', 0, '2019-11-13 12:13:26', '2019-11-13 12:13:26'),
(71, 'APPROVE_GRN_RETURN', '', 'Approve GRN Return', 'web', 25, '2019-11-14 15:50:49', '2019-11-14 15:50:49'),
(79, 'MANAGE_PAYMENT', '', 'Manage payment', 'web', 0, '2019-12-03 09:54:40', '2019-12-03 09:54:40'),
(80, 'ADD_PAYMENT', '', 'Add payment', 'web', 79, '2019-12-03 09:55:04', '2019-12-03 09:55:04'),
(81, 'EDIT_PAYMENT', '', 'Edit payment', 'web', 79, '2019-12-03 09:55:26', '2019-12-03 09:55:26'),
(102, 'MANAGE_PURCHASE_ORDER', '', 'Manage purchase order', 'web', 0, '2020-05-07 05:42:47', '2020-05-07 05:42:47'),
(103, 'ADD_PURCHASE_ORDER', '', 'Add purchase order', 'web', 102, '2020-05-07 05:43:20', '2020-05-07 05:43:20'),
(104, 'EDIT_PURCHASE_ORDER', '', 'Edit purchase order', 'web', 102, '2020-05-07 05:43:40', '2020-05-07 05:43:40'),
(105, 'APPROVE_PURCHASE_ORDER', '', 'Approve purchase order', 'web', 102, '2020-05-07 05:45:15', '2020-05-07 05:45:15'),
(106, 'MANAGE_PRODUCTION', '', 'Manage production', 'web', 0, '2020-05-07 06:00:50', '2020-05-07 06:00:50'),
(107, 'ADD_PRODUCTION', '', 'Add production', 'web', 106, '2020-05-07 06:01:12', '2020-05-07 06:01:12'),
(108, 'EDIT_PRODUCTION', '', 'Edit production', 'web', 106, '2020-05-07 06:01:38', '2020-05-07 06:01:38'),
(109, 'MANAGE_STORE_LOCATION', '', 'Manage store location', 'web', 0, '2020-05-07 06:01:53', '2020-05-07 06:01:53'),
(110, 'ADD_STORE_LOCATION', '', 'Add store location', 'web', 109, '2020-05-07 06:02:24', '2020-05-07 06:02:24'),
(111, 'EDIT_STORE_LOCATION', '', 'Edit store location', 'web', 109, '2020-05-07 06:02:40', '2020-05-07 06:02:40'),
(112, 'APPROVE_INVOICE', '', 'Approve invoice', 'web', 33, '2020-05-07 07:11:40', '2020-05-07 07:11:40'),
(113, 'INVENTORY_MANUAL_UPDATE', '', 'Inventory manual update', 'web', 0, '2020-05-07 09:03:05', '2020-05-07 09:03:05'),
(114, 'APPROVE_PRODUCTION', '', 'Approve production', 'web', 106, '2020-05-07 10:16:16', '2020-05-07 10:16:16'),
(115, 'MANAGE_CHEQUE_PAYMENT', '', 'Manage cheque payment', 'web', 33, '2020-08-28 23:58:48', '2020-08-28 23:58:48'),
(116, 'DELETE_CUSTOMER', '', 'Delete customer', 'web', 1, '2020-12-20 01:46:25', '2020-12-20 01:46:25'),
(117, 'MANAGE_AREAS', '', 'Manage areas', 'web', 0, '2020-12-20 02:03:08', '2020-12-20 02:03:08'),
(118, 'EDIT_AREA', '', 'Edit area', 'web', 117, '2020-12-20 02:03:28', '2020-12-20 02:15:08'),
(119, 'ADD_AREA', '', 'Add area', 'web', 117, '2020-12-20 02:03:47', '2020-12-20 02:03:47'),
(120, 'DELETE_AREA', '', 'Delete area', 'web', 117, '2020-12-20 02:04:01', '2020-12-20 02:04:01'),
(121, 'DELETE_GRN', '', 'Delete grn', 'web', 20, '2020-12-20 21:38:08', '2020-12-20 21:38:08'),
(122, 'DELETE_INVOICE', '', 'Delete invoice', 'web', 33, '2020-12-21 03:50:58', '2020-12-21 03:50:58'),
(123, 'CHANGE_INVOICE_PRODUCT_PRICE', '', 'Change invoice product price', 'web', 33, '2020-12-21 10:41:24', '2020-12-21 10:41:24');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_product`
--

CREATE TABLE `pramix_product` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `default_store_location` int(11) DEFAULT NULL,
  `kg` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `rent_per_week` double DEFAULT NULL,
...
--
-- Table structure for table `pramix_product_categories`
--

CREATE TABLE `pramix_product_categories` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `category_code` char(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `parent_id` int(11) NOT NULL,
  `description` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `show_in_invoice` char(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `created_by` int(11) NOT NULL,
  `updated_by` int(11) NOT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `pramix_product_discounts`
--

CREATE TABLE `pramix_product_discounts` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `pramix_product_raw_materials`
--

CREATE TABLE `pramix_product_raw_materials` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `pramix_product_store_locations`
--

CREATE TABLE `pramix_product_store_locations` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `pramix_product_store_locations`
--

INSERT INTO `pramix_product_store_locations` (`id`, `branch_id`, `location`, `description`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
(10, 1, 'Weerawila Mill', '', 7, 7, NULL, '2020-05-11 04:00:51', '2020-05-11 04:00:51'),
(11, 1, 'Debarawewa Mill', '', 7, 7, NULL, '2020-05-11 04:01:06', '2020-05-11 04:01:06'),
(12, 1, 'Pannagamuwa Paddy Store', '', 7, 7, NULL, '2020-05-11 04:01:36', '2020-05-11 04:01:36'),
(13, 1, 'Debarawewa Paddy Store', '', 7, 7, NULL, '2020-05-11 04:02:13', '2020-05-11 04:02:13'),
(14, 1, 'Bags Store', '', 5, 5, NULL, '2020-05-12 00:16:29', '2020-05-12 00:16:29');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_purchase_order`
--

CREATE TABLE `pramix_purchase_order` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
...
--
-- Table structure for table `pramix_purchase_order_payments`
--

CREATE TABLE `pramix_purchase_order_payments` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Table structure for table `pramix_purchase_order_products`
--

CREATE TABLE `pramix_purchase_order_products` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `purchase_order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
--
-- Table structure for table `pramix_roles`
--

CREATE TABLE `pramix_roles` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `pramix_roles`
--

INSERT INTO `pramix_roles` (`id`, `name`, `display_name`, `description`, `guard_name`, `created_at`, `updated_at`) VALUES
(1, 'SUPER_ADMINISTRATOR', 'SUPER ADMINISTRATOR', '', 'web', '2019-10-26 06:03:13', '2020-12-27 01:51:19'),
(2, 'ADMINISTRATOR', 'Administrator', '', 'web', '2019-10-26 06:04:37', '2020-05-07 11:07:30'),
(4, 'MANAGER', 'Manager', '', 'web', '2019-10-26 10:10:00', '2020-05-07 10:43:38'),
(5, 'OFFICE_USER_WITH_MAXIMIZED_RIGHTS', 'Office User With Maximized Rights', '', 'web', '2019-11-12 20:41:45', '2020-10-22 04:54:32'),
(6, 'USER_WITH_LIMITED_RIGHTS', 'User with Limited Rights', '', 'web', '2020-08-07 10:17:15', '2020-10-22 04:55:14'),
(7, 'REPRESENTATIVE', 'Representative', '', 'web', '2020-08-10 01:50:10', '2020-10-22 04:55:48'),
(8, 'USER35', 'S', '', 'web', '2021-01-05 03:37:30', '2021-01-05 03:37:30');

-- --------------------------------------------------------

--
-- Table structure for table `pramix_role_has_permissions`
--

CREATE TABLE `pramix_role_has_permissions` (
  `permission_id` bigint(20) UNSIGNED NOT NULL,
  `role_id` bigint(20) UNSIGNED NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `pramix_role_has_permissions`
--

INSERT INTO `pramix_role_has_permissions` (`permission_id`, `role_id`) VALUES
(1, 1),
(1, 2),
(1, 4),
(1, 6),
...
--
-- Table structure for table `pramix_send_sms`
--

CREATE TABLE `pramix_send_sms` (
  `id` int(10) UNSIGNED NOT NULL,
  `recipient_phone_no` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_id` int(11) DEFAULT NULL,
  `send_time` datetime NOT NULL,
  ...
  `type_id` int(11) NOT NULL COMMENT 'Send SMS , Birthday Wish',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `pramix_sms_types`
--

CREATE TABLE `pramix_sms_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `sms_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `pramix_users`
--

CREATE TABLE `pramix_users` (
  `id` int(10) UNSIGNED NOT NULL,
  `branch_id` int(11) DEFAULT NULL,
  `username` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `permission_type` char(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'R' COMMENT 'R = Role / P = Permissions',
  `fname` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lname` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telephone` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `theme` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'L' COMMENT 'L = Light, D = Dark',
...
--
-- Dumping data for table `pramix_users`
--

INSERT INTO `pramix_users` (`id`, `branch_id`, `username`, `permission_type`, `fname`, `lname`, `telephone`, `email`, `theme`, `password`, `status`, `email_verified_at`, `created_by`, `updated_by`, `remember_token`, `deleted_at`, `created_at`, `updated_at`) VALUES
(31, 1, 'cha', 'R', 'chandima', 'perera', NULL, 'hmschandima@gmail.com', 'L', '$2y$10$V7.IXI2c1I/KFbSLWzfhu.vB5gR8bmuf.SLl..Pq7zb2980XZI9sW', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:36:43', '2021-09-19 10:36:43'),
(30, 1, 'wjd', 'R', 'wijewardana', 'sarath', NULL, 'sarathwijewardana13@gmail.com', 'L', '$2y$10$IaeuRdgleNX4aAx3XEeuBOLe4kualK8wRyXg52ufjSsjO0A/QCf.W', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:32:35', '2021-09-19 10:32:35'),
(29, 1, 'DLN', 'R', 'Dilantha', 'km', NULL, 'km.88user@gmail.com', 'L', '$2y$10$ZJS6nWoU/9DzqF1vL.hagu9oWD89XxfhyPnbsX4k6zMe2ygqJNe5u', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:30:39', '2021-09-19 10:30:39'),
(28, 1, 'atn', 'R', 'anton', 'km', NULL, 'km.222.user@gmail.com', 'L', '$2y$10$FTMlRTwgvLLufpq7HfAIhO7ICsRAssgaEGHa7ZD7jdsGE.BzGIlTm', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:26:03', '2021-09-19 10:26:03'),
(27, 1, 'pmd', 'R', 'pamudu', 'priyath', NULL, 'pamupriyath21@gmail.com', 'L', '$2y$10$J93wqGnxSYUt2THRHpR.4O8deWBeZHXZHKGTDLax989vUqAp9GUTK', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:25:02', '2021-09-19 10:25:02'),
(26, 1, 'sdp', 'R', 'sandeepa', 'madumal', NULL, 'cmk.user10@gmail.com', 'L', '$2y$10$9Oluvywy4pTGlK6TB0Uzp.DoSVwd8rWHaX/W4H/Z6SFlyQiV5QdqC', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:21:40', '2021-09-19 10:21:40'),
(25, 1, 'thu', 'R', 'thusitha', 'kumara', NULL, 'cmk.101user@gmail.com', 'L', '$2y$10$YkmRNMp0x2cbRKtAmFX76.x7LyIveeU0wuvOV25MUVPGf1LJL.GrS', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:18:28', '2021-09-19 10:18:28'),
(24, 1, 'CMK1', 'R', 'OFFICE1', 'CMK', NULL, 'cmk.enterp@gmail.com', 'L', '$2y$10$uwYHrCtmDpbJlkGX/LVbd.3dYbOuac.6TAq8AaUtrdMiBHemxO/zG', '1', NULL, 1, 1, NULL, NULL, '2021-09-19 10:15:32', '2021-09-19 10:38:31'),
(23, 1, 'REF', 'R', 'demo', 'red', NULL, 'ref@cmk.com', 'L', '$2y$10$K7rfLuh2vXM0bVIvcZs/i.h37UCBDBiLMUW9gLtHV7jH44sWT9zMi', '1', NULL, 1, 1, NULL, NULL, '2021-09-01 15:24:45', '2021-09-01 15:24:45'),
(1, 1, 'admin', 'R', 'System', 'Admin', '+94771234567', 'admin@gmail.com', 'L', '$2y$10$Vwc/dAyslsYSm./XDQ9ssOtROF7MnXAG4DzYa6tEhg.X8N4ktTrWG', '1', '2019-09-08 00:00:00', 1, 1, 'vhnJm9XyIiJx10c5qPCyHZ0mU65hwl1zcrlBmZlg6XhdAxVaT2D1wM2k1oFD', NULL, '2019-10-26 12:58:58', '2020-05-07 16:18:42');
...
--
-- Indexes for table `pramix_address`
--
ALTER TABLE `pramix_address`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_areas`
--
ALTER TABLE `pramix_areas`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_average_cost_table`
--
ALTER TABLE `pramix_average_cost_table`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_branches`
--
ALTER TABLE `pramix_branches`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_cheque`
--
ALTER TABLE `pramix_cheque`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_cities`
--
ALTER TABLE `pramix_cities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_comments`
--
ALTER TABLE `pramix_comments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_configurations`
--
ALTER TABLE `pramix_configurations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_configuration_category`
--
ALTER TABLE `pramix_configuration_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_customer`
--
ALTER TABLE `pramix_customer`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_customer_account_activities`
--
ALTER TABLE `pramix_customer_account_activities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_districts`
--
ALTER TABLE `pramix_districts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_emails`
--
ALTER TABLE `pramix_emails`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_email_templates`
--
ALTER TABLE `pramix_email_templates`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_error_log_details`
--
ALTER TABLE `pramix_error_log_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pramix_error_log_details_file_id_foreign` (`file_id`);

--
-- Indexes for table `pramix_etemplates`
--
ALTER TABLE `pramix_etemplates`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_failed_jobs`
--
ALTER TABLE `pramix_failed_jobs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_file_uploaded_details`
--
ALTER TABLE `pramix_file_uploaded_details`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_grn`
--
ALTER TABLE `pramix_grn`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_grn_product`
--
ALTER TABLE `pramix_grn_product`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_grn_return`
--
ALTER TABLE `pramix_grn_return`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_grn_return_products`
--
ALTER TABLE `pramix_grn_return_products`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_inventory`
--
ALTER TABLE `pramix_inventory`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_invoice`
--
ALTER TABLE `pramix_invoice`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_invoice_payments`
--
ALTER TABLE `pramix_invoice_payments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_invoice_products`
--
ALTER TABLE `pramix_invoice_products`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_invoice_recurring`
--
ALTER TABLE `pramix_invoice_recurring`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_invoice_return`
--
ALTER TABLE `pramix_invoice_return`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_invoice_return_product`
--
ALTER TABLE `pramix_invoice_return_product`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_manufacture`
--
ALTER TABLE `pramix_manufacture`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_media`
--
ALTER TABLE `pramix_media`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_media_sort`
--
ALTER TABLE `pramix_media_sort`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_migrations`
--
ALTER TABLE `pramix_migrations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_model_has_permissions`
--
ALTER TABLE `pramix_model_has_permissions`
  ADD PRIMARY KEY (`permission_id`,`model_id`,`model_type`),
  ADD KEY `model_has_permissions_model_id_model_type_index` (`model_id`,`model_type`);

--
-- Indexes for table `pramix_model_has_roles`
--
ALTER TABLE `pramix_model_has_roles`
  ADD PRIMARY KEY (`role_id`,`model_id`,`model_type`),
  ADD KEY `model_has_roles_model_id_model_type_index` (`model_id`,`model_type`);

--
-- Indexes for table `pramix_password_resets`
--
ALTER TABLE `pramix_password_resets`
  ADD KEY `pramix_password_resets_email_index` (`email`);

--
-- Indexes for table `pramix_permissions`
--
ALTER TABLE `pramix_permissions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_product`
--
ALTER TABLE `pramix_product`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_product_categories`
--
ALTER TABLE `pramix_product_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_product_discounts`
--
ALTER TABLE `pramix_product_discounts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_product_raw_materials`
--
ALTER TABLE `pramix_product_raw_materials`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_product_store_locations`
--
ALTER TABLE `pramix_product_store_locations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_purchase_order`
--
ALTER TABLE `pramix_purchase_order`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_purchase_order_payments`
--
ALTER TABLE `pramix_purchase_order_payments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_purchase_order_products`
--
ALTER TABLE `pramix_purchase_order_products`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_roles`
--
ALTER TABLE `pramix_roles`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_role_has_permissions`
--
ALTER TABLE `pramix_role_has_permissions`
  ADD PRIMARY KEY (`permission_id`,`role_id`),
  ADD KEY `pramix_role_has_permissions_role_id_foreign` (`role_id`);

--
-- Indexes for table `pramix_send_sms`
--
ALTER TABLE `pramix_send_sms`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_sms_types`
--
ALTER TABLE `pramix_sms_types`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pramix_users`
--
ALTER TABLE `pramix_users`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `pramix_address`
--
ALTER TABLE `pramix_address`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `pramix_areas`
--
ALTER TABLE `pramix_areas`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `pramix_average_cost_table`
--
ALTER TABLE `pramix_average_cost_table`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_branches`
--
ALTER TABLE `pramix_branches`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pramix_cheque`
--
ALTER TABLE `pramix_cheque`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `pramix_cities`
--
ALTER TABLE `pramix_cities`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1847;

--
-- AUTO_INCREMENT for table `pramix_comments`
--
ALTER TABLE `pramix_comments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;

--
-- AUTO_INCREMENT for table `pramix_configurations`
--
ALTER TABLE `pramix_configurations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `pramix_configuration_category`
--
ALTER TABLE `pramix_configuration_category`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `pramix_customer`
--
ALTER TABLE `pramix_customer`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `pramix_customer_account_activities`
--
ALTER TABLE `pramix_customer_account_activities`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_districts`
--
ALTER TABLE `pramix_districts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `pramix_emails`
--
ALTER TABLE `pramix_emails`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_email_templates`
--
ALTER TABLE `pramix_email_templates`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_error_log_details`
--
ALTER TABLE `pramix_error_log_details`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_etemplates`
--
ALTER TABLE `pramix_etemplates`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_failed_jobs`
--
ALTER TABLE `pramix_failed_jobs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_file_uploaded_details`
--
ALTER TABLE `pramix_file_uploaded_details`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_grn`
--
ALTER TABLE `pramix_grn`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT for table `pramix_grn_product`
--
ALTER TABLE `pramix_grn_product`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT for table `pramix_grn_return`
--
ALTER TABLE `pramix_grn_return`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_grn_return_products`
--
ALTER TABLE `pramix_grn_return_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_inventory`
--
ALTER TABLE `pramix_inventory`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=384;

--
-- AUTO_INCREMENT for table `pramix_invoice`
--
ALTER TABLE `pramix_invoice`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=297;

--
-- AUTO_INCREMENT for table `pramix_invoice_payments`
--
ALTER TABLE `pramix_invoice_payments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `pramix_invoice_products`
--
ALTER TABLE `pramix_invoice_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;

--
-- AUTO_INCREMENT for table `pramix_invoice_recurring`
--
ALTER TABLE `pramix_invoice_recurring`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_invoice_return`
--
ALTER TABLE `pramix_invoice_return`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_invoice_return_product`
--
ALTER TABLE `pramix_invoice_return_product`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_manufacture`
--
ALTER TABLE `pramix_manufacture`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `pramix_media`
--
ALTER TABLE `pramix_media`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `pramix_media_sort`
--
ALTER TABLE `pramix_media_sort`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `pramix_migrations`
--
ALTER TABLE `pramix_migrations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=93;

--
-- AUTO_INCREMENT for table `pramix_permissions`
--
ALTER TABLE `pramix_permissions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;

--
-- AUTO_INCREMENT for table `pramix_product`
--
ALTER TABLE `pramix_product`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_product_categories`
--
ALTER TABLE `pramix_product_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_product_discounts`
--
ALTER TABLE `pramix_product_discounts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_product_raw_materials`
--
ALTER TABLE `pramix_product_raw_materials`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_product_store_locations`
--
ALTER TABLE `pramix_product_store_locations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `pramix_purchase_order`
--
ALTER TABLE `pramix_purchase_order`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_purchase_order_payments`
--
ALTER TABLE `pramix_purchase_order_payments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_purchase_order_products`
--
ALTER TABLE `pramix_purchase_order_products`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_roles`
--
ALTER TABLE `pramix_roles`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `pramix_send_sms`
--
ALTER TABLE `pramix_send_sms`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_sms_types`
--
ALTER TABLE `pramix_sms_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pramix_users`
--
ALTER TABLE `pramix_users`
